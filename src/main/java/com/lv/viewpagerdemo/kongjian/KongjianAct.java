package com.lv.viewpagerdemo.kongjian;
 ...
 * Description:
 */
public class KongjianAct extends AppCompatActivity {
    public static void startKongjianAct(Activity activity) {
        activity.startActivity(new Intent(activity, KongjianAct.class));
    }
        ...
        adapter.setRecyclerClickListener(new RecyclerAdapter.RecyclerClickListener() {
            ...
            public void onClick(int position) {
                if (position == 0) {
                    ...
                    spaceNavigationView.showBadgeAtIndex(1, 4, ContextCompat.getColor(KongjianAct.this, R.color.badge_background_color));
